# Gemini Gem Setup Guide: Telegram Pipeline Heartbeat
...
Enter the name: **Telegram Pipeline Heartbeat**
...
Open your new Gem and try a few of the test prompts from `skills/telegram-pipeline-heartbeat/TESTS.md` to verify it is working correctly.
...
3. Select **Telegram Pipeline Heartbeat**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/telegram-pipeline-heartbeat`
