# Gemini Gem Setup Guide: Hyperparameter Search Strategy
...
Enter the name: **Hyperparameter Search Strategy**
...
Open your new Gem and try a few of the test prompts from `skills/hyperparameter-search-strategy/TESTS.md` to verify it is working correctly.
...
3. Select **Hyperparameter Search Strategy**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/hyperparameter-search-strategy`
