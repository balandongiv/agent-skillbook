# Gemini Gem Setup Guide: Manuscript Artifact Provenance and Generator Naming
...
Enter the name: **Manuscript Artifact Provenance and Generator Naming**
...
Open your new Gem and try a few of the test prompts from `skills/manuscript-artifact-provenance/TESTS.md` to verify it is working correctly.
...
3. Select **Manuscript Artifact Provenance and Generator Naming**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/manuscript-artifact-provenance`
