# Gemini Gem Setup Guide: ChatGPT UI Batch Screener
...
Enter the name: **ChatGPT UI Batch Screener**
...
Open your new Gem and try a few of the test prompts from `skills/chatgpt-ui-batch-screener/TESTS.md` to verify it is working correctly.
...
3. Select **ChatGPT UI Batch Screener**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/chatgpt-ui-batch-screener`
