# Gemini Gem Setup Guide: MNE Blink Report HTML
...
Enter the name: **MNE Blink Report HTML**
...
Open your new Gem and try a few of the test prompts from `skills/mne-blink-report-html/TESTS.md` to verify it is working correctly.
...
3. Select **MNE Blink Report HTML**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/mne-blink-report-html`
