# Gemini Gem Setup Guide: Knowledge-Library-Grounded Literature Review Writing
...
Enter the name: **Knowledge-Library-Grounded Literature Review Writing**
...
Open your new Gem and try a few of the test prompts from `skills/literature-review-writing/TESTS.md` to verify it is working correctly.
...
3. Select **Knowledge-Library-Grounded Literature Review Writing**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/literature-review-writing`
