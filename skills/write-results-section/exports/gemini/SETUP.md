# Gemini Gem Setup Guide: Write Results Section from Verified Numbers
...
Enter the name: **Write Results Section from Verified Numbers**
...
Open your new Gem and try a few of the test prompts from `skills/write-results-section/TESTS.md` to verify it is working correctly.
...
3. Select **Write Results Section from Verified Numbers**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/write-results-section`
