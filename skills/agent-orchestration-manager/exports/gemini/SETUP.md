# Gemini Gem Setup Guide: Agent Orchestration Manager
...
Enter the name: **Agent Orchestration Manager**
...
Open your new Gem and try a few of the test prompts from `skills/agent-orchestration-manager/TESTS.md` to verify it is working correctly.
...
3. Select **Agent Orchestration Manager**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/agent-orchestration-manager`
