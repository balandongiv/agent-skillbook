# Gemini Gem Setup Guide: Exploratory Evaluation Discipline
...
Enter the name: **Exploratory Evaluation Discipline**
...
Open your new Gem and try a few of the test prompts from `skills/exploratory-eval-discipline/TESTS.md` to verify it is working correctly.
...
3. Select **Exploratory Evaluation Discipline**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/exploratory-eval-discipline`
