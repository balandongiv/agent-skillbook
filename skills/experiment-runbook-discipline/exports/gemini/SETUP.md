# Gemini Gem Setup Guide: Experiment Runbook Discipline
...
Enter the name: **Experiment Runbook Discipline**
...
Open your new Gem and try a few of the test prompts from `skills/experiment-runbook-discipline/TESTS.md` to verify it is working correctly.
...
3. Select **Experiment Runbook Discipline**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/experiment-runbook-discipline`
