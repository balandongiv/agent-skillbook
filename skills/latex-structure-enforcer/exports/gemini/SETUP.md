# Gemini Gem Setup Guide: LaTeX Thesis Structure Enforcer
...
Enter the name: **LaTeX Thesis Structure Enforcer**
...
Open your new Gem and try a few of the test prompts from `skills/latex-structure-enforcer/TESTS.md` to verify it is working correctly.
...
3. Select **LaTeX Thesis Structure Enforcer**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/latex-structure-enforcer`
