# Gemini Gem Setup Guide: Manuscript Final Compile QC Gate
...
Enter the name: **Manuscript Final Compile QC Gate**
...
Open your new Gem and try a few of the test prompts from `skills/manuscript-final-qc/TESTS.md` to verify it is working correctly.
...
3. Select **Manuscript Final Compile QC Gate**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/manuscript-final-qc`
