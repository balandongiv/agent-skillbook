# Gemini Gem Setup Guide: ChatGPT UI Reasoning Session
...
Enter the name: **ChatGPT UI Reasoning Session**
...
Open your new Gem and try a few of the test prompts from `skills/chatgpt-ui-reasoning/TESTS.md` to verify it is working correctly.
...
3. Select **ChatGPT UI Reasoning Session**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/chatgpt-ui-reasoning`
