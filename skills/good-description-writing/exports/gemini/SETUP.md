# Gemini Gem Setup Guide: Good Description Writing
...
Enter the name: **Good Description Writing**
...
Open your new Gem and try a few of the test prompts from `skills/good-description-writing/TESTS.md` to verify it is working correctly.
...
1. Regenerate: `python tools/render_gemini_gem.py skills/good-description-writing`
