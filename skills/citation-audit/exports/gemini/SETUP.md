# Gemini Gem Setup Guide: Citation Relevance Audit
...
Enter the name: **Citation Relevance Audit**
...
Open your new Gem and try a few of the test prompts from `skills/citation-audit/TESTS.md` to verify it is working correctly.
...
3. Select **Citation Relevance Audit**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/citation-audit`
