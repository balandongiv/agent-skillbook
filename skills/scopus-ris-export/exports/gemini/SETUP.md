# Gemini Gem Setup Guide: Scopus RIS Export Automation
...
Enter the name: **Scopus RIS Export Automation**
...
Open your new Gem and try a few of the test prompts from `skills/scopus-ris-export/TESTS.md` to verify it is working correctly.
...
3. Select **Scopus RIS Export Automation**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/scopus-ris-export`
