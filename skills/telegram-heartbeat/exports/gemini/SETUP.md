# Gemini Gem Setup Guide: Telegram Agent Heartbeat and Notifications
...
Enter the name: **Telegram Agent Heartbeat and Notifications**
...
Open your new Gem and try a few of the test prompts from `skills/telegram-heartbeat/TESTS.md` to verify it is working correctly.
...
3. Select **Telegram Agent Heartbeat and Notifications**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/telegram-heartbeat`
