# Gemini Gem Setup Guide: Code Readability Best Practices
...
Enter the name: **Code Readability Best Practices**
...
Open your new Gem and try a few of the test prompts from `skills/code-readability-best-practices/TESTS.md` to verify it is working correctly.
...
3. Select **Code Readability Best Practices**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/code-readability-best-practices`
