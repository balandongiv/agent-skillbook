# Gemini Gem Setup Guide: Subject Outlier Review
...
Enter the name: **Subject Outlier Review**
...
Open your new Gem and try a few of the test prompts from `skills/subject-outlier-review/TESTS.md` to verify it is working correctly.
...
3. Select **Subject Outlier Review**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/subject-outlier-review`
