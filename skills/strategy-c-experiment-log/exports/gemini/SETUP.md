# Gemini Gem Setup Guide: Strategy C Experiment Log
...
Enter the name: **Strategy C Experiment Log**
...
Open your new Gem and try a few of the test prompts from `skills/strategy-c-experiment-log/TESTS.md` to verify it is working correctly.
...
3. Select **Strategy C Experiment Log**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/strategy-c-experiment-log`
