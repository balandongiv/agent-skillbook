...
description: Turn ambiguous, half-baked, or outdated plans into living planning docs aligned with code, config, paths, execution flow, checks, failure modes, and debugging navigation.
