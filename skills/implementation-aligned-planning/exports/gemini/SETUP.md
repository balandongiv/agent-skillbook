# Gemini Gem Setup Guide: Implementation-Aligned Planning
...
Enter the name: **Implementation-Aligned Planning**
...
Open your new Gem and try a few of the test prompts from `skills/implementation-aligned-planning/TESTS.md` to verify it is working correctly.
...
3. Select **Implementation-Aligned Planning**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/implementation-aligned-planning`
