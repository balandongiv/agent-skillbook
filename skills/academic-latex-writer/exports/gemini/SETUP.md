# Gemini Gem Setup Guide: Academic LaTeX Paragraph Writer (ChatGPT UI)
...
Enter the name: **Academic LaTeX Paragraph Writer (ChatGPT UI)**
...
Open your new Gem and try a few of the test prompts from `skills/academic-latex-writer/TESTS.md` to verify it is working correctly.
...
3. Select **Academic LaTeX Paragraph Writer (ChatGPT UI)**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/academic-latex-writer`
