# Gemini Gem Setup Guide: Codex-Driven Coding with Tiered Intelligence
...
Enter the name: **Codex-Driven Coding with Tiered Intelligence**
...
Open your new Gem and try a few of the test prompts from `skills/codex-driven-coding/TESTS.md` to verify it is working correctly.
...
3. Select **Codex-Driven Coding with Tiered Intelligence**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/codex-driven-coding`
