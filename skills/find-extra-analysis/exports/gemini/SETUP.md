# Gemini Gem Setup Guide: Find Extra Analyses from Abstract or Results
...
Enter the name: **Find Extra Analyses from Abstract or Results**
...
Open your new Gem and try a few of the test prompts from `skills/find-extra-analysis/TESTS.md` to verify it is working correctly.
...
3. Select **Find Extra Analyses from Abstract or Results**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/find-extra-analysis`
