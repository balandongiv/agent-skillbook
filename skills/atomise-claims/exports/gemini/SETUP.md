# Gemini Gem Setup Guide: Atomise Claims into Atomic Statements
...
Enter the name: **Atomise Claims into Atomic Statements**
...
Open your new Gem and try a few of the test prompts from `skills/atomise-claims/TESTS.md` to verify it is working correctly.
...
3. Select **Atomise Claims into Atomic Statements**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/atomise-claims`
