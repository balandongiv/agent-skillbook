# Gemini Gem Setup Guide: Manuscript Results Curation
...
Enter the name: **Manuscript Results Curation**
...
Open your new Gem and try a few of the test prompts from `skills/manuscript-results-curation/TESTS.md` to verify it is working correctly.
...
3. Select **Manuscript Results Curation**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/manuscript-results-curation`
