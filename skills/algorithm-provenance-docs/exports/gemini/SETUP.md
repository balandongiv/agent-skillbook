# Gemini Gem Setup Guide: Algorithm Provenance Documentation
...
Enter the name: **Algorithm Provenance Documentation**
...
Open your new Gem and try a few of the test prompts from `skills/algorithm-provenance-docs/TESTS.md` to verify it is working correctly.
...
3. Select **Algorithm Provenance Documentation**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/algorithm-provenance-docs`
