# Gemini Gem Setup Guide: Evidence-Driven Thesis Writer
...
Enter the name: **Evidence-Driven Thesis Writer**
...
Open your new Gem and try a few of the test prompts from `skills/evidence-driven-thesis-writer/TESTS.md` to verify it is working correctly.
...
3. Select **Evidence-Driven Thesis Writer**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/evidence-driven-thesis-writer`
