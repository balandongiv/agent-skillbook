# Gemini Gem Setup Guide: Write Discussion Section with Defensible Claims
...
Enter the name: **Write Discussion Section with Defensible Claims**
...
Open your new Gem and try a few of the test prompts from `skills/write-discussion-section/TESTS.md` to verify it is working correctly.
...
3. Select **Write Discussion Section with Defensible Claims**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/write-discussion-section`
