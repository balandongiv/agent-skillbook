# Gemini Gem Setup Guide: Parallel Agents in Git Worktrees
...
Enter the name: **Parallel Agents in Git Worktrees**
...
Open your new Gem and try a few of the test prompts from `skills/worktree-parallel-agents/TESTS.md` to verify it is working correctly.
...
3. Select **Parallel Agents in Git Worktrees**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/worktree-parallel-agents`
