# Gemini Gem Setup Guide: IntelliJ Line Debugging
...
Enter the name: **IntelliJ Line Debugging**
...
Open your new Gem and try a few of the test prompts from `skills/intellij-line-debugging/TESTS.md` to verify it is working correctly.
...
3. Select **IntelliJ Line Debugging**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/intellij-line-debugging`
