# Gemini Gem Setup Guide: Real-Data Validation Promotion
...
Enter the name: **Real-Data Validation Promotion**
...
Open your new Gem and try a few of the test prompts from `skills/real-data-validation-promotion/TESTS.md` to verify it is working correctly.
...
3. Select **Real-Data Validation Promotion**
...
1. Regenerate: `python tools/render_gemini_gem.py skills/real-data-validation-promotion`
