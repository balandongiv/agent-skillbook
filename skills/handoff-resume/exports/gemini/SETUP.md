# Gemini Gem Setup Guide: Handoff Resume
...
Open your new Gem and try a few of the test prompts from `skills/handoff-resume/TESTS.md` to verify it is working correctly.
...
1. Regenerate: `python tools/render_gemini_gem.py skills/handoff-resume`
